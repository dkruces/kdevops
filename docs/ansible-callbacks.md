...
The verbosity level can also be configured via Kconfig:

```bash
make menuconfig
# Navigate to: General kdevops settings -> Ansible verbosity level
```

Or override at runtime:

```bash
make AV=1 target  # Force verbosity level 1 for this run
```
